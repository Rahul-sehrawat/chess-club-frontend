        ...
        <div className="pt-2 max-w-screen-lg   w-full">
            <div className="grid grid-cols-6 gap-4 w-full">
                <div className=" col-span-5 w-full flex justify-center flex-col">
                    <div className="text-white bottom-2 w-3/4 font-bold text-xl pb-2 flex gap-2 items-center"><img src="/avatar.png " width={38}></img><span className=" text-2xl">player 2</span><span className=" font-thin">{`(500 )`}</span></div>
                    <ChessBoard chess={chess} setBoard={setBoard} socket={socket} board={board} />
                    <div className="text-white bottom-2 w-3/4 font-bold text-xl pt-2 flex gap-2 items-center"><img src="/avatar.png " width={38}></img>
                    <div>
                    <span className=" text-2xl mr-1">{user?.name}</span><span className=" font-thin ">{`(500 )`}</span>
                    </div>
                    </div>
                </div>
